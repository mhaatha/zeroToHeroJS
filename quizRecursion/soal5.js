...
3 => 3, karena sudah satu digit 24 => 8. Karena 24 dua digit, maka kita lakukan 2 * 4 = 8. 8 satu digit, maka hasilnya adalah 8. 654 => 0. Karena 654 tiga digit, maka lakukan 6 * 5 * 4 = 120. 120 tiga digit, mak a lakukan 1 * 2 * 0 = 0. 0 satu digit, maka hasilnya adalah 0.
*/
...
function kaliTerusRekursif(angka) {
  ...
  const digitTerakhir = angka % 10;
  const sisaDigit = Math.floor(angka / 10);
  const total = digitTerakhir * kaliTerusRekursif(sisaDigit);
