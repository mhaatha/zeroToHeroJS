...
/* ====================================================ALGORITMA====================================================
    1. "Memecah" sebuah kalimat lalu tampilkan setiap kata di dalamnya
    2. Gunakan akses satu per satu karakter dari string untuk mengambil setiap huruf dalam kata
    3. Tiap dapat huruf, untuk membuat kata gunakan simbol + 
   =================================================================================================================
*/
console.log('================================================');
...
// ---------------------------------------
console.log('================================================');
console.log(`Ini adalah kalimatnya: ${exampleFirstWord} ${secondWord} ${thirdWord} ${fourthWord} ${fifthWord}`);
console.log('================================================');
// ---------------------------------------